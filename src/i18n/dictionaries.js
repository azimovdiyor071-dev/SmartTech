...
export const DICTS = {
  en: {
    ...
    // invoices
    invoicesSub: 'invoices generated', generateInvoice: 'Generate Invoice', totalInvoiced: 'Total Invoiced', paidStat: 'Paid', unpaidStat: 'Unpaid', invoiceGenerated: 'Invoice generated.', searchInvoices: 'Search invoices…', printingX: 'Printing', exportedPdf: 'exported to PDF.',
    // warranty
    ...
    // employees
    employeesSub1: 'staff across', branchesWord: 'branches', rolesWord: 'roles', addEmployee: 'Add Employee', totalStaff: 'Total Staff', activeStat: 'Active', rolesStat: 'Roles', searchEmployees: 'Search employees…', addEmployeeDemo: 'Add employee form.', allRoles: 'All roles',
    // branches
    ...
    'notif.newOrder': 'New order received', 'notif.newOrderBody': 'A customer placed a new order.', 'notif.payment': 'Payment received', 'notif.paymentBody': 'A payment was received.', 'notif.lowStock': 'Low stock alert', 'notif.lowStockBody': 'A product is below its reorder level.', 'notif.warranty': 'Warranty expiring', 'notif.warrantyBody': 'Some warranties expire soon.', 'notif.service': 'Service completed', 'notif.serviceBody': 'A repair was completed.', 'notif.delivered': 'Order delivered', 'notif.deliveredBody': 'An order was delivered to the customer.',
    // settings
    settingsSub: 'Manage your company profile and system configuration', tabCompany: 'Company', tabLocalization: 'Localization', tabFinance: 'Finance & Tax', tabIntegrations: 'Integrations', tabSystem: 'System & API', companyProfile: 'Company Profile', companyName: 'Company name', supportEmail: 'Support email', website: 'Website', addressField: 'Address', interfaceLang: 'Interface language', timezone: 'Timezone', dateFormat: 'Date format', financeTax: 'Finance & Tax', currency: 'Currency', taxRate: 'VAT / Tax rate (%)', invoicePrefix: 'Invoice prefix', fiscalYear: 'Fiscal year start', notifChannels: 'Notification Channels', systemApi: 'System & API', apiKey: 'API Key', regenKey: 'Regenerate Key', backupNow: 'Backup Now', settingsSaved: 'Settings saved.', connectedDemo: 'connected.', keyGenerated: 'New API key generated.', backupStarted: 'Backup started.',
    // forms / crud
  ...
  uz: {
    ...
    // customers
    customersLower: 'mijoz', lifetimeValue: 'umumiy qiymat', vipCustomers: 'VIP mijozlar', addCustomer: "Mijoz qo'shish", allSegments: 'Barcha segmentlar', customerProfile: 'Mijoz profili', purchaseHistory: 'Xaridlar tarixi', noOrdersYet: "Hali buyurtma yo'q.", joinedField: "Qo'shilgan", lastOrderField: 'Oxirgi buyurtma', cityBranchField: 'Shahar / Filial', custSaved: 'Mijoz yangilandi.', custFormDemo: "Yangi mijoz formasi.",
    // products
    skusAcross: 'SKU,', categoriesWord: 'toifa', addProduct: "Mahsulot qo'shish", totalSkus: 'Jami SKU', stockValueCost: 'Zaxira qiymati (tannarx)', lowOutStock: 'Kam / Tugagan', productDetails: 'Mahsulot tafsilotlari', sellingPrice: 'Sotuv narxi', costPrice: 'Tannarx', margin: 'Foyda %', stockQty: 'Qoldiq miqdori', reorderLevel: 'Minimal daraja', warrantyField: 'Kafolat', variantsField: 'Variantlar', unitsSoldField: 'Sotilgan dona', months: 'oy', prodSaved: 'Mahsulot yangilandi.', prodFormDemo: "Yangi mahsulot formasi.", allCategories: 'Barcha toifalar',
    // orders
    ordersRevenue: 'daromad', createOrder: 'Buyurtma yaratish', totalOrders: 'Jami buyurtmalar', pendingStat: 'Kutilayotgan', deliveredStat: 'Yetkazilgan', createOrderDemo: 'Buyurtma yaratish.', searchOrderCust: 'Buyurtma # yoki mijoz…', allStatuses: 'Barcha holatlar',
    // order detail
    orderPlaced: 'Berilgan', invoicePdf: 'Faktura PDF', itemsWord: 'Mahsulotlar', subtotal: 'Oraliq jami', discount: 'Chegirma', taxLabel: 'Soliq (12%)', customerCard: 'Mijoz', salesRep: 'Sotuvchi', deliveryCard: 'Yetkazish', orderDate: 'Buyurtma sanasi', printingInvoice: 'Faktura chop etilmoqda…', invoiceExported: 'Faktura PDF eksport qilindi.', orderNotFound: 'Buyurtma topilmadi', orderNotExist: 'Bunday buyurtma mavjud emas', orderRemoved: "U o'chirilgan bo'lishi mumkin.",
    // inventory
    invSubtitle: "Ombor qoldiqlari, ogohlantirishlar va o'zgartirishlar", stockTransfer: 'Zaxira transferi', totalUnits: 'Jami donalar', lowStockStat: 'Kam qoldiq', outStockStat: 'Tugagan', stockAdded: "Zaxiraga qo'shildi.", stockRemoved: 'Zaxiradan olindi.', searchInventory: 'Omborni qidirish…', stockTransferDemo: 'Zaxira transferi yaratildi.',
    // payments
    ...
    // invoices
    invoicesSub: 'ta faktura yaratilgan', generateInvoice: 'Faktura yaratish', totalInvoiced: 'Jami hisoblangan', paidStat: "To'langan", unpaidStat: "To'lanmagan", invoiceGenerated: 'Faktura yaratildi.', searchInvoices: 'Fakturalarni qidirish…', printingX: 'Chop etilmoqda', exportedPdf: 'PDF eksport qilindi.',
    // warranty
    ...
    // employees
    employeesSub1: 'xodim,', branchesWord: 'filial', rolesWord: 'rol', addEmployee: "Xodim qo'shish", totalStaff: 'Jami xodimlar', activeStat: 'Faol', rolesStat: 'Rollar', searchEmployees: 'Xodimlarni qidirish…', addEmployeeDemo: "Xodim qo'shish formasi.", allRoles: 'Barcha rollar',
    // branches
    ...
    'notif.newOrder': 'Yangi buyurtma keldi', 'notif.newOrderBody': 'Mijoz yangi buyurtma berdi.', 'notif.payment': "To'lov qabul qilindi", 'notif.paymentBody': "To'lov qabul qilindi.", 'notif.lowStock': 'Kam zaxira ogohlantirishi', 'notif.lowStockBody': 'Mahsulot minimal darajadan pastga tushdi.', 'notif.warranty': 'Kafolat tugayapti', 'notif.warrantyBody': 'Ba\'zi kafolatlar tez orada tugaydi.', 'notif.service': 'Xizmat yakunlandi', 'notif.serviceBody': "Ta'mir yakunlandi.", 'notif.delivered': 'Buyurtma yetkazildi', 'notif.deliveredBody': 'Buyurtma mijozga yetkazildi.',
    // settings
    settingsSub: 'Kompaniya profili va tizim sozlamalarini boshqaring', tabCompany: 'Kompaniya', tabLocalization: 'Til va mintaqa', tabFinance: 'Moliya va soliq', tabIntegrations: 'Integratsiyalar', tabSystem: 'Tizim va API', companyProfile: 'Kompaniya profili', companyName: 'Kompaniya nomi', supportEmail: 'Qo\'llab-quvvatlash email', website: 'Veb-sayt', addressField: 'Manzil', interfaceLang: 'Interfeys tili', timezone: 'Vaqt mintaqasi', dateFormat: 'Sana formati', financeTax: 'Moliya va soliq', currency: 'Valyuta', taxRate: 'QQS / Soliq stavkasi (%)', invoicePrefix: 'Faktura prefiksi', fiscalYear: 'Moliyaviy yil boshi', notifChannels: 'Bildirishnoma kanallari', systemApi: 'Tizim va API', apiKey: 'API kaliti', regenKey: 'Kalitni yangilash', backupNow: 'Zaxira nusxa', settingsSaved: 'Sozlamalar saqlandi.', connectedDemo: 'ulandi.', keyGenerated: 'Yangi API kaliti yaratildi.', backupStarted: 'Zaxira boshlandi.',
    // forms / crud
  ...
  ru: {
    ...
    // customers
    customersLower: 'клиентов', lifetimeValue: 'пожизненная ценность', vipCustomers: 'VIP-клиенты', addCustomer: 'Добавить клиента', allSegments: 'Все сегменты', customerProfile: 'Профиль клиента', purchaseHistory: 'История покупок', noOrdersYet: 'Заказов пока нет.', joinedField: 'Регистрация', lastOrderField: 'Последний заказ', cityBranchField: 'Город / Филиал', custSaved: 'Клиент обновлён.', custFormDemo: 'Форма нового клиента.',
    // products
    skusAcross: 'SKU в', categoriesWord: 'категориях', addProduct: 'Добавить товар', totalSkus: 'Всего SKU', stockValueCost: 'Стоимость остатка', lowOutStock: 'Мало / Нет в наличии', productDetails: 'Детали товара', sellingPrice: 'Цена продажи', costPrice: 'Себестоимость', margin: 'Маржа', stockQty: 'Количество на складе', reorderLevel: 'Минимальный уровень', warrantyField: 'Гарантия', variantsField: 'Варианты', unitsSoldField: 'Продано штук', months: 'мес.', prodSaved: 'Товар обновлён.', prodFormDemo: 'Форма нового товара.', allCategories: 'Все категории',
    // orders
    ordersRevenue: 'выручка', createOrder: 'Создать заказ', totalOrders: 'Всего заказов', pendingStat: 'В ожидании', deliveredStat: 'Доставлено', createOrderDemo: 'Создание заказа.', searchOrderCust: 'Поиск № заказа или клиента…', allStatuses: 'Все статусы',
    // order detail
    orderPlaced: 'Оформлен', invoicePdf: 'Счёт PDF', itemsWord: 'Товары', subtotal: 'Подытог', discount: 'Скидка', taxLabel: 'Налог (12%)', customerCard: 'Клиент', salesRep: 'Продавец', deliveryCard: 'Доставка', orderDate: 'Дата заказа', printingInvoice: 'Печать счёта…', invoiceExported: 'Счёт экспортирован в PDF.', orderNotFound: 'Заказ не найден', orderNotExist: 'Такого заказа нет', orderRemoved: 'Возможно, он был удалён.',
    // inventory
    invSubtitle: 'Остатки на складе, оповещения и корректировки', stockTransfer: 'Перемещение', totalUnits: 'Всего единиц', lowStockStat: 'Низкий остаток', outStockStat: 'Нет в наличии', stockAdded: 'Добавлено на склад.', stockRemoved: 'Списано со склада.', searchInventory: 'Поиск по складу…', stockTransferDemo: 'Перемещение создано.',
    // payments
    ...
    // invoices
    invoicesSub: 'счетов создано', generateInvoice: 'Создать счёт', totalInvoiced: 'Всего выставлено', paidStat: 'Оплачено', unpaidStat: 'Не оплачено', invoiceGenerated: 'Счёт создан.', searchInvoices: 'Поиск счетов…', printingX: 'Печать', exportedPdf: 'экспортирован в PDF.',
    // warranty
    ...
    // employees
    employeesSub1: 'сотрудников в', branchesWord: 'филиалах', rolesWord: 'ролей', addEmployee: 'Добавить сотрудника', totalStaff: 'Всего сотрудников', activeStat: 'Активные', rolesStat: 'Роли', searchEmployees: 'Поиск сотрудников…', addEmployeeDemo: 'Форма нового сотрудника.', allRoles: 'Все роли',
    // branches
    ...
    'notif.newOrder': 'Новый заказ', 'notif.newOrderBody': 'Клиент оформил новый заказ.', 'notif.payment': 'Платёж получен', 'notif.paymentBody': 'Получен платёж.', 'notif.lowStock': 'Мало на складе', 'notif.lowStockBody': 'Товар ниже минимального уровня.', 'notif.warranty': 'Гарантия истекает', 'notif.warrantyBody': 'Некоторые гарантии скоро истекают.', 'notif.service': 'Сервис завершён', 'notif.serviceBody': 'Ремонт завершён.', 'notif.delivered': 'Заказ доставлен', 'notif.deliveredBody': 'Заказ доставлен клиенту.',
    // settings
    settingsSub: 'Управляйте профилем компании и настройками системы', tabCompany: 'Компания', tabLocalization: 'Локализация', tabFinance: 'Финансы и налоги', tabIntegrations: 'Интеграции', tabSystem: 'Система и API', companyProfile: 'Профиль компании', companyName: 'Название компании', supportEmail: 'Email поддержки', website: 'Веб-сайт', addressField: 'Адрес', interfaceLang: 'Язык интерфейса', timezone: 'Часовой пояс', dateFormat: 'Формат даты', financeTax: 'Финансы и налоги', currency: 'Валюта', taxRate: 'НДС / Ставка налога (%)', invoicePrefix: 'Префикс счёта', fiscalYear: 'Начало фин. года', notifChannels: 'Каналы уведомлений', systemApi: 'Система и API', apiKey: 'API ключ', regenKey: 'Обновить ключ', backupNow: 'Резервная копия', settingsSaved: 'Настройки сохранены.', connectedDemo: 'подключено.', keyGenerated: 'Новый API ключ создан.', backupStarted: 'Резервное копирование начато.',
    // forms / crud
